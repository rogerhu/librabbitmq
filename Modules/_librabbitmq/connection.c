 ...
 */
static PyObject*
PyRabbitMQ_Connection_connect(PyRabbitMQ_Connection *self, PyObject *args, PyObject *kwargs)
{
    int status;
    ...
    if(!PyArg_ParseTupleAndKeywords(args, kwargs, "|O", kwlist, &client_properties)) {
      goto bail;
    }
